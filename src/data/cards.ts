...
export const cards: Card[] = [
  ...
  // Friends — Easy — Truth
  { id: 'friends-easy-t01', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'What is your most embarrassing nickname?' },
  { id: 'friends-easy-t02', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'Who in this group do you text the most?' },
  { id: 'friends-easy-t03', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'What is a song you secretly love?' },
  { id: 'friends-easy-t04', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'What is the last thing you searched on your phone?' },
  { id: 'friends-easy-t05', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'Who is your celebrity crush?' },
  { id: 'friends-easy-t06', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'What is your most used emoji?' },
  { id: 'friends-easy-t07', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'What is your comfort food?' },
  { id: 'friends-easy-t08', type: 'truth', difficulty: 'easy', pack: 'friends', text: 'What is the worst movie you have ever watched?' },

  // Friends — Easy — Dare
  { id: 'friends-easy-d01', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Do your best impression of someone in the group.' },
  { id: 'friends-easy-d02', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Send a selfie to the last person you texted.' },
  { id: 'friends-easy-d03', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Speak in an accent for the next round.' },
  { id: 'friends-easy-d04', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Do 10 jumping jacks right now.' },
  { id: 'friends-easy-d05', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Let the person on your left post a story on your social media.' },
  { id: 'friends-easy-d06', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Sing the chorus of your favorite song.' },
  { id: 'friends-easy-d07', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Make a funny face and keep it for 15 seconds.' },
  { id: 'friends-easy-d08', type: 'dare', difficulty: 'easy', pack: 'friends', text: 'Compliment every person in the group in 30 seconds.' },

  // Friends — Medium — Truth
  { id: 'friends-med-t01', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'What is a secret you have never told anyone?' },
  { id: 'friends-med-t02', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'What is the biggest lie you have told your parents?' },
  { id: 'friends-med-t03', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'Who in this group would you call first in an emergency?' },
  { id: 'friends-med-t04', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'What is something you are glad your friends do not know about you?' },
  { id: 'friends-med-t05', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'Have you ever pretended to like a gift you hated?' },
  { id: 'friends-med-t06', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'What is the most childish thing you still do?' },
  { id: 'friends-med-t07', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'When was the last time you cried and why?' },
  { id: 'friends-med-t08', type: 'truth', difficulty: 'medium', pack: 'friends', text: 'What is the worst advice you have ever given?' },

  // Friends — Medium — Dare
  { id: 'friends-med-d01', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Let someone go through your camera roll for 30 seconds.' },
  { id: 'friends-med-d02', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Post an ugly selfie on your social media.' },
  { id: 'friends-med-d03', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Talk without closing your mouth for the next round.' },
  { id: 'friends-med-d04', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Imitate a teacher or boss from your life.' },
  { id: 'friends-med-d05', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Let the group pick a song and you must dance to it.' },
  { id: 'friends-med-d06', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Text your crush "I miss you" right now.' },
  { id: 'friends-med-d07', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Do a dramatic reading of the last message you received.' },
  { id: 'friends-med-d08', type: 'dare', difficulty: 'medium', pack: 'friends', text: 'Switch phones with someone for the rest of the game.' },

  // Friends — Hard — Truth
  { id: 'friends-hard-t01', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'What is the most hurtful thing you have said to a friend?' },
  { id: 'friends-hard-t02', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'Have you ever talked about a friend behind their back today?' },
  { id: 'friends-hard-t03', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'What is your biggest insecurity about yourself?' },
  { id: 'friends-hard-t04', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'Which friend here do you trust the least and why?' },
  { id: 'friends-hard-t05', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'What is something you did that you are deeply ashamed of?' },
  { id: 'friends-hard-t06', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'Have you ever stolen something? What was it?' },
  { id: 'friends-hard-t07', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'What is a friendship you ruined and what happened?' },
  { id: 'friends-hard-t08', type: 'truth', difficulty: 'hard', pack: 'friends', text: 'If you could change one thing about each person here, what would it be?' },

  // Friends — Hard — Dare
  { id: 'friends-hard-d01', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Call a friend not in this group and sing them a song.' },
  { id: 'friends-hard-d02', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Let everyone in the group post one thing on your Instagram.' },
  { id: 'friends-hard-d03', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Reveal your search history to the group.' },
  { id: 'friends-hard-d04', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Do a handstand (or attempt one) against the wall.' },
  { id: 'friends-hard-d05', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Speak only in questions for the next 3 rounds.' },
  { id: 'friends-hard-d06', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Let someone draw on your face with a marker.' },
  { id: 'friends-hard-d07', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Eat a spoonful of the worst condiment combination someone picks.' },
  { id: 'friends-hard-d08', type: 'dare', difficulty: 'hard', pack: 'friends', text: 'Send "I have a crush on you" to the last person you messaged.' },
